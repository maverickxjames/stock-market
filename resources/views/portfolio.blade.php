						...
						<div class="card portofolio">
							<div class="card-header border-0 pb-0">
								...
								<div class="dropdown custom-dropdown mb-0 tbl-orders-style">
									...
									<div class="dropdown-menu dropdown-menu-end">
										<a onclick="window.location.href='{{ route('profile') }}'"  class="dropdown-item" href="javascript:void(0);">Details</a>
								...
								<div class="text-center my-profile">
									<div class="media d-block">
										<div class="media-img">
											...
											<a onclick="window.location.href='{{ route('profile') }}'" href="javascript:void(0);"><i class="fas fa-pencil-alt" aria-hidden="true"></i></a>
										</div>
									...
									<div class="media-content">
										<h4 class="mt-3 font-w400 fs-16 text-dark mb-0">Join on {{date("d F Y", strtotime($user['created_at']))}}</h4>
										<button onclick="window.location.href='{{ route('order') }}'" class="my-3 btn btn-success">View Orders </button>
									</div>
