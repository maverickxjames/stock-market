              ...
              <div class="card">
                <div class="card-header">
                  <div class="d-flex justify-content-between w-100">
                    <h1 class="card-title" style="font-size: 1.5rem; font-family:serif; font-weight:800px;">Recent Users
                    </h1>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="{{route('user',$user->id)}}" class="btn btn-primary">View</a>
                        </td>
                      </tr>
                      @endforeach
                    </tbody>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <div class="d-flex justify-content-between w-100">
                    <h3 class="card-title" style="font-size: 1.5rem; font-family:serif; font-weight:800px;">Recent
                ...
                <div class="card-body">
                  ...
                  <table id="example2" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      $deposit=Deposit::where('status',0)->orderBy('created_at','DESC')->get();
                      @endphp
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <table id="example3" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      @php
                      $withdraw=Withdraw::where('status',0)->orderBy('created_at','DESC')->get();
                      @endphp
                      ...
                      <tr>
                        ...
                        <td>
                          <form>
                            @csrf
                          <button class="btn btn-success"
                            onclick="withdraw_approve('{{$row->order_id}}','confirm')">Approve</button>
                          <button class="btn btn-warning"
                            onclick="withdraw_approve('{{$row->order_id}}','decline')">Decline</button>
                          </form>
                        </td>
                      </tr>
                      @endforeach
          ...
          success: function(data) {
            Swal.close();
              ...
              if (response.status === 'success') {
                  const message = response.type === 'confirm' 
